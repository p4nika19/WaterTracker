...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.aogiritree.watertracker\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [31 x i8] c"libaot-WaterTrackerApp1.dll.so\00", align 1
