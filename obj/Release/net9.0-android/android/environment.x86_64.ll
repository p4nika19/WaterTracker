...
@aot_dso_cache = dso_local local_unnamed_addr global [756 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x19b5f96fba0fbea0, ; from name: aot-WaterTrackerApp1
		i64 u0x2e232c3b67e89606, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterTrackerApp1.dll.so
		ptr null; void* handle
	}, ; 80
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x2e232c3b67e89606, ; from name: libaot-WaterTrackerApp1.dll.so
		i64 u0x2e232c3b67e89606, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterTrackerApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x3e0b72334184d77c, ; from name: aot-WaterTrackerApp1.dll.so
		i64 u0x2e232c3b67e89606, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterTrackerApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x454546b863a64cc8, ; from name: aot-WaterTrackerApp1.so
		i64 u0x2e232c3b67e89606, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterTrackerApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x542fca3a7b9182cb, ; from name: WaterTrackerApp1
		i64 u0x2e232c3b67e89606, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterTrackerApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x759a57e9f1cb65b0, ; from name: libaot-WaterTrackerApp1
		i64 u0x2e232c3b67e89606, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterTrackerApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xb6c0333bc2c641e6, ; from name: WaterTrackerApp1.so
		i64 u0x2e232c3b67e89606, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterTrackerApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xca6af36f75e3da8d, ; from name: libaot-WaterTrackerApp1.so
		i64 u0x2e232c3b67e89606, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterTrackerApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xe1530fea05dae6f0, ; from name: WaterTrackerApp1.dll.so
		i64 u0x2e232c3b67e89606, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-WaterTrackerApp1.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.aogiritree.watertracker\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [31 x i8] c"libaot-WaterTrackerApp1.dll.so\00", align 16
